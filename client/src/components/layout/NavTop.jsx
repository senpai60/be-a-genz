...
function NavTop({ navLinks, currentPage, navigateToLinkPage }) {
  ...
  return (
    <nav className="w-[80%] h-20 fixed right-0 top-0 p-4 flex justify-between items-center border-b border-b-zinc-800">
      ...
      <div className="right flex items-center gap-4">
        ...
        className="outline outline-zinc-600 w-80 rounded p-1 placeholder:text-zinc-600" type="search" name="search-global" id="" />
        <button className={`bg-zinc-900 p-2 rounded transition-all ${globalSearchValue===""?"hidden":""}`}>Search</button>
        <FaUser />
